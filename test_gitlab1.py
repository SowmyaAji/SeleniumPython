...
def test_create_new_file1(selenium):
    ...
    # selenium.get("http: // localhost/root/my-crazy-project")
...
# selenium.find_element_by_xpath('//a/bb[text()="zz"]/following-sibling::cc[1]/text()'
# selenium.find_element_by_xpath(
#     "(.//*[normalize-space(text()) and normalize-space(.)='M'])[1]/following::span[3]").click()
# selenium.find_element_by_xpath(
#     "(.//*[normalize-space(text()) and normalize-space(.)='Snippets'])[4]/following::span[1]").click()
# selenium.find_element_by_xpath(
#     "(.//*[normalize-space(text()) and normalize-space(.)='This project has no badges'])[1]/following::h4[1]").click()
# selenium.find_element_by_xpath(
#     "(.//*[normalize-space(text()) and normalize-space(.)='Removed projects cannot be restored!'])[1]/following::input[1]").click()
# selenium.find_element_by_xpath(
#     "(.//*[normalize-space(text()) and normalize-space(.)='Confirmation required'])[1]/following::p[2]").click()
# selenium.find_element_by_id("confirm_name_input").click()
# selenium.find_element_by_id("confirm_name_input").clear()
# selenium.find_element_by_id("confirm_name_input").send_keys(
#     "my-crazy-projectcrazy-project")

# hover = ActionChains(selenium).move_to_element(
#     element)
# setting = selenium.find_element_by_link_text('General')
# hover1 = ActionChains(selenium).move_to_element(setting)
# hover1.click().perform()
# selenium.find_element_by_link_text('Advanced').click()
# selenium.find_element_by_class_name('btn-remove').click()
# selenium.find_element_by_id('confirm_name_input').click()
# selenium.find_element_by_id('confirm_name_input').click(
# ).send_keys('my-crazy-projectcrazy-project')
# selenium.find_element_by_name('commit').click()
